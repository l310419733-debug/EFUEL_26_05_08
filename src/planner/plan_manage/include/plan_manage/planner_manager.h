...
public:
  ...
  bool kinodynamicReplan(const Eigen::Vector3d& start_pt, const Eigen::Vector3d& start_vel,
      ...
      const Eigen::Vector3d& end_vel, double& time_first, const double& time_lb = -1);
  ...
  void planYawExplore(const Eigen::Vector3d& start_yaw, const double& end_yaw, bool lookfwd,
      const double& relax_time, const double& time_ratio);
  
  void planYYawExplore(const Eigen::Vector3d &start_yaw, const double &end_yaw, bool lookfwd, const double &relax_time, const double &time_ratio);
  void planYawForYawing(const Eigen::Vector3d &start_yaw, const double &end_yaw, bool lookfwd, const double &relax_time, const double &time_ratio);
