...
private:
  ...
  int bspline_degree_;
  double ld_smooth_, ld_dist_, ld_feasi_, ld_start_, ld_guide_, ld_waypt_, ld_view_,
      ld_time_, ld_swarm_;
  double dist0_;              // safe distance
  double max_vel_, max_acc_, max_dyaw_, max_ddyaw_;  // dynamic limits
  double wnl_, dlmin_;
  ...
  vector<Eigen::Vector3d> g_q_, g_smoothness_, g_distance_, g_feasibility_, g_start_, g_end_,
      g_guide_, g_waypoints_, g_view_, g_time_, g_swarm_, g_yaw_;
